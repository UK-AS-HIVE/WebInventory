...
do
  ...
  curl -X POST -H "Content-Type:application/json" -d "{\"host\": \"`hostname -f`\", \"siteroot\": \"`pwd`\", \"modules\": ${MODULE_VERSIONS}}" http://meteordev.as.uky.edu/WebInventory/api/drupalSiteInfo
